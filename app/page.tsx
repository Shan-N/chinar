...
//         </div>
//       </section>
//       <section className={twMerge("relative px-4 md:px-32 flex bg-[#bd0a0ac9] flex-col gap-4 py-4 overflow-hidden", inter.className)}>
//         <MapleWhiteLeafBackground />
//         <h2 className="font-bold text-white text-xl md:text-2xl">Visit Chinar Hospitality &amp; Dine In</h2>
//         <span className="text-sm md:text-normal text-white">Come see how we turn your vision into an amazing experience. We look forward to welcoming you with open arms! Plan a visit today and experience the Chinar Hospitality magic. We&apos;re excited to meet you!</span>
//         <div className="flex flex-col">
//         </div>
//       </section>
//       <Footer />
